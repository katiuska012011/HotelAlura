...
public class RegistroHuesped extends JFrame {
	...
	public RegistroHuesped(int numeroReserva) {
		...
		lblTitulo.setBounds(606, 55, 350, 42);
		...
		btnguardar.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
//				codigo de guardar los registros

				var huesped = new Huesped(txtNombre.getText(), txtApellido.getText(),
						txtFechaN.getDate(), txtNacionalidad.getSelectedItem().toString(), txtTelefono.getText(), numeroReserva);
				...
				|| txtNacionalidad.getSelectedItem().toString().isEmpty()){
					...
					JOptionPane.showMessageDialog(null, "Su registro ha sido guardado exitosamente");
